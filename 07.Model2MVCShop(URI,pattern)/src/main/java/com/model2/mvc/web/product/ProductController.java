...
import com.model2.mvc.service.domain.ProductOnlyString;
...
public class ProductController {
	...
	public String addProduct(@ModelAttribute ProductOnlyString productEx, @RequestParam Integer price, Model model) throws Exception {
		Product product = new Product(productEx);
